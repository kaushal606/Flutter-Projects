...
import 'package:flutter_app_design8/screens/onboarding/model/onboard_page_model.dart';
import 'package:flutter_app_design8/screens/onboarding/components/drawerPaint.dart';
...
class _OnboardPageState extends State<OnboardPage> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    animationController = AnimationController(vsync: this, duration: Duration(milliseconds: 750));
  ...
  _nextButtonPressed() {
    Provider.of<ColorProvide>(context).color =
           ...
           children: <Widget>[
             AnimatedBuilder(
                 ...
                 builder: (context, child) {
                   return Transform.translate(offset: Offset(heroAnimation.value, 0),
                     child: Padding(
